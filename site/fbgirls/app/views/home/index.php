...
<html class="no-js">
	...
	<body>
		...
		<div class="row" id="main">
			<div class="large-9 columns left-pabel">1</div>
			<div class="large-3 columns right-panel">2</div>
		</div>

		<!-- <div class="backblur" src="/assets/images/backblur.jpg" width="300" height="200"></> -->
		<!-- <div class="row">
		  <div class="small-4 large-3 columns">1</div>
		  <div class="small-8 large-9 columns">2</div>
		</div> -->
